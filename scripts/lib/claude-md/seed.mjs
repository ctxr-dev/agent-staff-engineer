...
const STUB_BODY = [
  ...
  "agent runs surface concrete examples. The agent bundle ships an authoring",
  "guide alongside this template; see `design/claude-md-authoring.md` inside",
  "the agent bundle (commonly `.claude/agents/agent-staff-engineer/` in the",
  "target project, or `~/.claude/agents/agent-staff-engineer/` for a",
  "user-global install).]",
  "",
  "## Compound learning",
  "",
  ...
  "",
  "<!-- Append entries here via the bundle's append-entry helper:",
  "       node <bundle>/scripts/lib/claude-md/append-entry.mjs --section worked ...",
  "     Entry shape: see <bundle>/templates/claude-md/compound-learning.md. -->",
  "",
  ...
  "### Codebase quirks",
  "",
  "<!-- Append via the bundle's append-entry helper with --section quirk:",
  "       node <bundle>/scripts/lib/claude-md/append-entry.mjs --section quirk ...",
