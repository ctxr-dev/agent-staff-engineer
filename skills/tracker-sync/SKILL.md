...
- **Jira / GitLab**: every namespace stubbed today; every op throws `NotSupportedError`. Callers catch and halt cleanly. Real backends land in follow-up PRs.
